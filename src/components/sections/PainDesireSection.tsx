        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <Card className="p-6 md:p-8 card-premium border-red-500/20">
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl font-heading font-bold text-red-500 mb-2">
                ANTES
              </h3>
          ...
          <Card className="p-6 md:p-8 card-premium border-success/20">
            ...
            <div className="space-y-4">
              {desires.map((desire, index) => (
                <div key={index} className="flex items-start gap-3 p-4 bg-success/5 rounded-lg border border-success/10">
